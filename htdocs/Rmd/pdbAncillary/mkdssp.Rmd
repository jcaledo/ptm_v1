...
### Arguments
_pdb_ is either a 4-character identifier of the PDB structure, or the path to a pdb file.

_method_ a character string specifying the desired method to get the dssp dataframe; it should be one of 'ptm' or 'bio3d'.

_exefile_ file path to the DSSP executable on your system (i.e. how is DSSP invoked).
