...
### Arguments
_id_ the 4-character identifier of the PDB structure.

_destfile_ a character string with the path to the directory in which you want to save the downloaded file.
...
### See Also
_parse.dssp()_, _compute.dssp()_, _mkdssp()_ and _acc.dssp()_
