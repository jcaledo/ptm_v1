...
### Description
Computes and retuns a DSSP file
...
_destfile_ a character string with the path where the DSSP file is going to be saved.
...
### See Also
_parse.dssp()_, _download.dssp()_, _mkdssp()_ and _acc.dssp()_
