...
_db_	a character string specifying the desired database; it must be one of 'uniprot', 'metosite', 'pdb', 'kegg-aa', 'kegg-nt'.

_as.string_	logical, if TRUE the imported sequence will be returned as a character string.
