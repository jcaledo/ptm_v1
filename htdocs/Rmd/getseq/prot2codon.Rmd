...
### Arguments
_prot_	is either a UniProt or PDB id, or the path to a pdb file.

_chain_	when prot corresponds to a pdb, the chain of interest must be provided.

_laxity_	logical, if FALSE the program stop when a mismatch between the protein and the gene sequences is detected. Otherwise The program finishes running and at the end points out the mismatches.
...
* [get.seq](./get.seq)
* prot2codon (the current document)
